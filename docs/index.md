...
Welcome to the documentation for the [FHGR Helm charts](https://github.com/fh-gr/common-helm-charts) project.
...
```sh
helm repo add fhgr http://fhgr.github.io/helm-charts/
```
